...
def Video2Frames_multiLabel(Path_label_folder, Path_fullFrame_folder, Path_2dFrame_folder, Path_3dMatrix_folder, data_type):
    ...
    for label_id in os.listdir(Path_label_folder):
        ...
        Path_3dMatrix = Path_3dMatrix_folder +data_type+ "/" + label_id+"/"
        ...
        for VideoName in os.listdir(Path_label_folder+"/"+label_id+data_type):
            if 'mp4' in VideoName:
...
Video2Frames_multiLabel(Path_label_folder, Path_fullFrame_folder, Path_2dFrame_folder, Path_3dMatrix_folder, data_type)
